...
async function main() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Hỗ trợ giải đáp về các vấn đề sinh sản và hiếm muộn.',
      price: 10000,
      category: 'Sinh sản và hiếm muộn',
      type: ServiceType.Consultation,
      available_modes: [ServiceMode.AT_CLINIC, ServiceMode.ONLINE],
    },
    {
      name: 'Tư vấn bệnh lây qua đường tình dục',
      description: 'Tư vấn chuyên sâu về bệnh lây qua đường tình dục',
      price: 20000,
      category: ' Bệnh lây truyền qua đường tình dục',
      type: ServiceType.Consultation,
      available_modes: [ServiceMode.AT_CLINIC, ServiceMode.ONLINE],
    },
    {
      name: 'Tư vấn dinh dưỡng người lớn',
      description: 'Lên kế hoạch ăn uống lành mạnh cho người trưởng thành.',
      price: 25000,
      category: 'Dinh dưỡng',
      type: ServiceType.Consultation,
      available_modes: [ServiceMode.AT_CLINIC, ServiceMode.ONLINE],
